...
function main_fit_VH(;mode=:plot_only, npts=200, t1=70, t2=151 , doplot=true, poff = 1.0)
    ...
    x = main_fit(VH,  start = (x0, x2), mode=mode, npts=npts, t1=70, t2=151 , doplot=true, poff = 1.0)
...
#    x0[1] = 0.0
    ...
    x = main_fit(VV,  start = (x0, x2), mode=mode, npts=npts, t1=70, t2=151 , doplot=true, poff = 1.0)
